...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, Trigger_Pin|LD3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : Trigger_Pin LD3_Pin */
  GPIO_InitStruct.Pin = Trigger_Pin|LD3_Pin;
