...
def get_sample_Duration():
    ...
    while True:
        try:
            sampleDuration = round(float(input("Sample Duration: ")),
                                   3)  # round just in case the user asks for some ridiculous precision that exceeds the precision of our sample rate
